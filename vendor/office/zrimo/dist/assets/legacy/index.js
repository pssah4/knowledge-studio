 ...
 * @returns {Uint8Array}
 */
export function convertLegacyToOoxml(data, format) {
    try {
        ...
        wasm.convertLegacyToOoxml(retptr, ptr0, len0, ptr1, len1);
 ...
 * @returns {string}
 */
export function extractLegacyPlainText(data, format) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        const ptr1 = passStringToWasm0(format, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        wasm.extractLegacyPlainText(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
