// Generated from app/participation-sync.js by scripts/sync-contracts.mjs.
export function createParticipationSync(environment){
(function(global){
'use strict';
...
return environment.WikiParticipationSync;
}
