/* Asynchronous document review (IMP-08-02-01, ADR-22).
   Immutable events travel with their content folder; local checkpoints never do.
   A prepared document change is evidence only after its completion receipt exists.
   The filesystem's existing guarded write remains the authority at every save. */
(function(global){
'use strict';
